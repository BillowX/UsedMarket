...
/**
 * 显示捐赠动态的XRecyclerView
 * Created by XT on 2016/10/9.
 */

public class DonationsDynamicXRecyclerView extends XRecyclerView implements View.OnClickListener {
    ...
    public DonationsDynamicXRecyclerView(Context context, CoordinatorLayout cl_root) {
        this(context, null, 0, cl_root);
    }

    public DonationsDynamicXRecyclerView(Context context, AttributeSet attrs, CoordinatorLayout cl_root) {
        this(context, attrs, 0, cl_root);
    }

    public DonationsDynamicXRecyclerView(Context context, AttributeSet attrs, int defStyle, CoordinatorLayout cl_root) {
    ...
    private void initView() {
        ...
        setRefreshProgressStyle(ProgressStyle.BallGridBeat);
        setLoadingMoreProgressStyle(ProgressStyle.BallClipRotate);
        //设置Item增加、移除动画
