...
public class UsedFragment extends BaseFragment implements HeaderScrollHelper.ScrollableContainer {
    ...
    public void initView() {
        ...
        //添加头布局（店铺）
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.list_item_header_used_hobby, (ViewGroup) getActivity().findViewById(android.R.id.content), false);
//        View view = View.inflate(UIUtils.getContext(), R.layout.list_item_header_used_hobby, null);
        mMyXRecyclerView.addHeaderView(view);
