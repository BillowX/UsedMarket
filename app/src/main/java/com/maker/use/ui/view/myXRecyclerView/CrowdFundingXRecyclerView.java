...
public class CrowdFundingXRecyclerView extends XRecyclerView implements View.OnClickListener {
    ...
    public CrowdFundingXRecyclerView(Context context, CoordinatorLayout cl_root) {
        this(context, null, 0, cl_root);
    }

    public CrowdFundingXRecyclerView(Context context, AttributeSet attrs, CoordinatorLayout cl_root) {
        this(context, attrs, 0, cl_root);
    }

    public CrowdFundingXRecyclerView(Context context, AttributeSet attrs, int defStyle, CoordinatorLayout cl_root) {
