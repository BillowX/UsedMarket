package com.maker.use.utils.map;
...
public class LocationActivity extends Activity implements LocationSource,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mapView = (MapView) findViewById(R.id.mv_route);
        mlist = (ListView) findViewById(R.id.lv_location);
...
//        aMap.setMyLocationStyle(myLocationStyle);
    ...
    public void onCameraChangeFinish(CameraPosition cameraPosition) {
        ...
        co.center(l);
        co.radius(2000);
        co.strokeColor(Color.WHITE).fillColor(getResources().getColor(R.color.action_bar_color)).strokeWidth(3);
        aMap.clear();
        aMap.addCircle(co);
        lp = new LatLonPoint(a, b);
        doSearchQuery();
